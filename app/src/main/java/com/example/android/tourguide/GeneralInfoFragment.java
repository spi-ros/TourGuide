...
public class GeneralInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Place(getString(R.string.place_poseidon), getString(R.string.info_poseidon),
                ...
                getString(R.string.tag_fragmentG), getString(R.string.link_poseidon), getString(R.string.generalInfo_tag_1)));
        ...
        places.add(new Place(getString(R.string.place_acropolis), getString(R.string.info_acropolis),
                ...
                getString(R.string.tag_fragmentG), getString(R.string.link_acropolis), getString(R.string.generalInfo_tag_2)));
        ...
        places.add(new Place(getString(R.string.place_odeon), getString(R.string.info_odeon),
                ...
                getString(R.string.tag_fragmentG), getString(R.string.link_odeon), getString(R.string.generalInfo_tag_3)));
        ...
        places.add(new Place(getString(R.string.place_agora), getString(R.string.info_agora),
                ...
                getString(R.string.tag_fragmentG), getString(R.string.link_agora), getString(R.string.generalInfo_tag_4)));

        places.add(new Place(getString(R.string.place_monastiraki), getString(R.string.info_monastiraki),
                R.drawable.monastiraki, getString(R.string.geo_monastiraki), getString(R.string.phone_monastiraki)
                , getString(R.string.tag_fragmentG), getString(R.string.link_monastiraki), getString(R.string.generalInfo_tag_5)));
